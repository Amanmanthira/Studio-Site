...
const Footer = () => {
  return (
    ...
    <div class="relative mt-16  bg-gray-700 ">
  <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-gray-700" preserveAspectRatio="none" viewBox="0 0 1440 54">
  ...
  <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    ...
    <div class="flex flex-col justify-between pt-5 pb-10 border-t border-gray-200 sm:flex-row">
